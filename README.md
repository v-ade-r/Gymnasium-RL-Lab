...
The repository contains clean implementations of classic and modern RL algorithms with
educational comments, grouped by [Gymnasium](https://gymnasium.farama.org/) environment and
learning paradigm — from tabular methods to deep RL and evolutionary optimization.

It was created as a practical lab for hands-on experiments with algorithms I had previously
studied theoretically. Beyond theoretical alignment, the core focus of these experiments was 
to explore industry best practices and environment-specific tuning tricks (explained in the code).
